...
applied it to viral phylogenies estimated from \del{five}\add{ten} published
...
well as the total number of nodes, were not estimable with ABC. \del{We
observed substantial heterogeneity in the parameter estimates on real datasets,
with point estimates for the preferential attachment power ranging from 0.06 to
1.05.} \add{We observed sub-linear preferential attachment (PA) power in all
datasets, as well as higher PA power in networks of injection drug users.}
