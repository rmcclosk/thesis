...
The error in the estimated prevalence $I$ was slightly lower for smaller values
of $\alpha$
...
between the number of sequences in the tree and the estimated prevalence
...
datasets have bost of the posteriormass on m = 1. Estimates of N are
meaningless.}
...
Dr. Richard Harrigan, and the anonymous reviewers for many helpful
