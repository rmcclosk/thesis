...
first contact network model incorporating pcreferential attachment was
...
package~\autocite{karatzoglou2004kernlab}, and evaluated its accuracy with 1000
...
a simple pcreferential attachment model giving rise to the power law degree
