...
\begin{figure}[ht]
  \centering
  \includegraphics[width=\textwidth]{sir-trajectories.pdf}
...
%    capt <- paste(capt.short, "GLM was fitted with a Gamma distribution and",
...
%                  "identity link function. Coefficients are interpretable as",
