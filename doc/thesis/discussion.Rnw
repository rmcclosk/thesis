...
following a prospective cohort of 2000 \gls{MSM} in Beijing, China. Of the
2000, 179 new infections were identified during the study period. This number
is much lower than the estimated prevalence of X obtained with
\software{netabc}, however the authors did not claim to have sampled the entire
sexual network. In a nationwide survey, \textcite{wu2013hiv} estimated that
there were 24,198 \gls{MSM} living in Beijing, of whom 5.7\%, or 1379, were
\gls{HIV}-infected, which is within the 95\% confidence interval of our
estimate of \gls{I}.}

\uline{\textcite{li2015hiv} studied an \gls{MSM} population in Shanghai, China.
Despite the apparent similarity to the context of the
\textcite{wang2015targeting} study, the estimated \gls{HIV} prevalence of the
\citeauthor{li2015hiv} data was higher (X). The aforementioned
...
claimed that there were 80,000 \gls{MSM} living in Shanghai, which is a
