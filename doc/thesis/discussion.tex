...
\software{netabc}, the 95\% \gls{HPD} intervals for \gls{I} usually contained
...
%As mentioned above, \gls{I} and \gls{N} were both systematically over-estimated
%by our method, although the bias was more severe for \gls{N} than for \gls{I}.
%
%When \gls{N} was held fixed and \gls{I} was varied, grid search was able to
%recover \gls{I} without bias (\cref{fig:est}). 
