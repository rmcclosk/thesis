...
$\alpha < 1$ than for $\alpha \geq 1$ (\cref{fig:abcpt,tab:abchpd}). The
...
(\cref{fig:rsquared,fig:Ncrossv}) coroborates this hypothesis, as the
...
(\cref{fig:abcpt,tab:abchpd}). One factor which may have contributed to this
