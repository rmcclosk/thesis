...
\begin{tikzpicture}[yscale=0.5]
  ...
  \node (t2) [below=0.5 of t1] {\includegraphics[height=1cm]{cat}};
  \node (t3) [below=0.5 of t2] {\includegraphics[height=1cm]{rabbit}};
  \node (t4) [below=1.5 of t3] {\includegraphics[height=1cm]{chameleon}};
  \node (t5) [below=of t4] {\includegraphics[height=1cm]{fish}};
