...
that the variation in \defn{evolutionary rate}, which is the ratio of a
...
%\comment{are tip dates part of the prior?} 
...
into the network, also known as the \defn{index case}, becomes the root of the
...
continuation of the donor lineage. \Cref{fig:contactnet} illustrates this
...
tracing. The most common of these properties is the \defn{degree distribution}
...
There have been a few statistical methods developed to infer contact network
...
\defn{superspreaders}~\autocite{kemper1980identification}.
...
There has been some contention of the idea that sexual networks are scale-free.
