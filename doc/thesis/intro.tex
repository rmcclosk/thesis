...
\begin{align}
  ...
  \label{eq:post}
\end{align}
where we have adopted the common abuse of the symbol $\Pr$ to refer to a
probability density. \uline{As alluded to in} \cref{sec:obj}, \uline{both the
...
\[
  ...
  \frac{\pi(\theta) \Pr(z \mid \theta) \I_{A_{\varepsilon, y}} (z)}
  {\int_{A_{\varepsilon, y} \times \Theta} \pi(\theta) \Pr(z \mid \theta) \d \theta}.
\]
