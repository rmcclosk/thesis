...
\uline{Having introduced transmission trees and contact network models, we are
now in a position to argue that approximate Bayesian computation is an
appropriate tool to apply towards our main objective: fitting network models to
phylogenetic data. Let $M$ be a contact network model having parameters
$\theta$. 
