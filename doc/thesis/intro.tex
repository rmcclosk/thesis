...
virus strains. \defn{Inter-host} phylogenies relate one representative viral
...
the transmission process is quite similar to \defn{allopatric
...
A \defn{Markov kernel} is the continuous analogue of the transition matrix in a
