...
package~\autocite{plummer2006coda}.}} {\color{blue}\uline{Posterior means and
credible intervals were obtained for each parameter using the
\software{wtd.mean} and \software{wtd.quantile} functions in the
\software{Hmisc} package~\autocite{harrell2016hmisc}. }}
