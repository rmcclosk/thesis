...
\newacronym{HCV}{HCV}{hepatitis C virus}
...
\newglossaryentry{beta}{
  ...
  description=transmission rate in susceptible-infected and susceptible-infected-removed epidemiological models
}
\newglossaryentry{nu}{
  name=\ensuremath{\nu},
  description=recovery rate in the susceptible-infected-removed epidemiological model
}
\newglossaryentry{m}{
  name=\ensuremath{m},
...
\newglossaryentry{gI}{
  ...
  description=set of infected nodes in Gillespie simulation
}
\newglossaryentry{gR}{
  name=\ensuremath{\mathcal{R}},
  description=set of recovered nodes in Gillespie simulation
}
\newglossaryentry{gS}{
...
\newglossaryentry{gD}{
  ...
  description=set of discordant edges in Gillespie simulation
}
...
\newglossaryentry{T}{
  name=\ensuremath{T},
  description=a transmission tree
}
\newglossaryentry{tmax}{
  name=\ensuremath{t_{\max}},
  description=user-defined cutoff time at which to stop Gillespie simulation
}
\newglossaryentry{t}{
  name=\ensuremath{t},
  description=time since initial infection of index case in an epidemic
}
\newglossaryentry{rho}{
  name=\ensuremath{\rho},
  description=distance function for approximate Bayesian computation
}
...
\newglossaryentry{q}{
  name=\ensuremath{q},
  description=proposal function for Metropolis-Hastings kernel
}
\newglossaryentry{R0}{
  name=\ensuremath{R_0},
  description=basic reproductive number; average number of infections
  ultimately caused by one infected individual
}
