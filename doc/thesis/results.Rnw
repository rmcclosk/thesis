...
colgate1989risk, brown2011transmission}. Higher estimated values of $\alpha$
translated into higher estimated values of $\gamma$, which is consistent with
the observed relationship between these two quantities (\cref{fig:gamma}).
